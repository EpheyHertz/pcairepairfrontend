...
// import { FiSend, FiImage, FiX, FiMenu, FiSun, FiMoon } from 'react-icons/fi';
...
//     try {
//       const response = await axios.get(`http://127.0.0.1:8000/apis/chats/${chatId}/messages/`, {
//         headers: {
//           Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
//         },
//       });
...
//       const response = await axios.post('http://127.0.0.1:8000/apis/chatbot-diagnose/', formData, {
//         headers: {
...
//             <li
//               key={id}
//               className={`p-2 border-b cursor-pointer ${selectedChat && chat.chat_id === chatId ? 'bg-blue-600 text-white' : ''}`}
...
//       {/* // <button */}
//       {/* //   onClick={toggleTheme}
//       //   className="absolute bottom-4 right-4 bg-gray-700 p-3 rounded-full shadow-lg hover:bg-gray-600"
//       // >
//       //   {theme === 'light' ? <FiMoon size={24} className="text-white" /> : <FiSun size={24} className="text-white" />}
//       // </button> */} 
//     </div>
//     </ProtectedRoute>
//   );
...
const ChatPage = () => {
  ...
  //   try {
  //     // Send request to delete the chat from the backend
  //     await axios.delete(`http://127.0.0.1:8000/apis/chats/${chatId}/`, {
  //       headers: {
  //         Authorization: `Bearer ${localStorage.getItem('accessToken')}`,
  //       },
  //     });
